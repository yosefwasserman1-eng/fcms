...
const constants = Object.freeze({
	...
	oauth2: {
		authorizationURL: 'https://keycloak.corinthian.local/realms/CorinthianArchive/protocol/openid-connect/auth',
		tokenURL: 'https://keycloak.corinthian.local/realms/CorinthianArchive/protocol/openid-connect/token',
		clientID: nconf.get('oauth:id'), // don't change this line
		clientSecret: nconf.get('oauth:secret'), // don't change this line
	},
	userRoute: 'https://keycloak.corinthian.local/realms/CorinthianArchive/protocol/openid-connect/userinfo', // This is the address to your app's "user profile" API endpoint (expects JSON)
...
OAuth.getStrategy = function (strategies, callback) {
	if (configOk) {
		...
		strategies.push({
			...
			labels: {
				login: '[[custom-sso:invite-login]]',    
				register: '[[custom-sso:invite-register]]'  
			},
